...
int main()
{
	...
	string filepath2 = "mesh_2-3-4_node.ply";
	...
	grid_filter(Q_cloud_ptr, P_cloud_ptr);
	FourPCS* pcs = new FourPCS(*P_cloud_ptr,*P_cloud_ptr);
	...
	savePointCloud(*P_cloud_ptr, "P_cloud_ptr.ply");
